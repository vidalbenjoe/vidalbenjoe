...
A SaaS clinic management platform designed to help clinics manage their operations in one place.
...
A software and automation studio helping businesses launch and improve their digital systems.
...
I use AI throughout the engineering lifecycle for:
...
I care about more than just shipping code.
...
**Simple → Maintainable → Scalable → Measurable**
...
End-to-end clinic operations platform covering appointments, patients, POS, inventory, reporting, automation, and analytics.
...
Beyond coding, I've worked as a technical lead responsible for:
